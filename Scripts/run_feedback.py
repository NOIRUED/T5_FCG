...
def main():
    ...
    for step, batch in enumerate(test_dataloader):
        with torch.no_grad():
            ...
            #for a in generated_tokens.sequences_scores:
                #print('{:.10f}'.format(a.item()))
            ...
            for pred, ref in zip(decoded_preds, decoded_labels):
                print(pred)
                #scores = scorer.score(references=[pred], candidates=[ref])
                #print(scores[0])
                #sub_metric.add_batch(predictions=[pred], references=[ref])
                #eval_sub = sub_metric.compute()
                #print(eval_sub["rougeL"].mid.fmeasure)
    ...
    try:
        ...
        f = 0
    print(f"precision: {f}, recall: {f}, f1: {f}")
